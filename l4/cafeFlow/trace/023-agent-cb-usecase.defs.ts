{
  "savedAt": "2026-07-25T23:28:55.490Z",
  ...
  "payload": {
    ...
    "result": {
      ...
      "arguments": {
        ...
        "questions": [],
        "trace": [
          "Mapped public inputs from userInput/selectedEntity: orderId, status, cancellationReason",
          "Excluded updatedAt (systemDefault via ctx.clock)",
          "output[] pinned to outputShape top-level fields",
          "ports union Order + StockConsumption (eventWrites audit)",
          "StockItem via ctx.mdm; auto deduction on serve with StockConsumption append in same tx",
          "Rules applied inline per L4 ids"
        ]
      }
    },
    "status": "completed",

...
export const definition = {
  ...
  "sections": [
    {
      "id": "section.posWorkspace.openOrdersSection",
      "type": "section",
      "sectionName": "Pedidos Abertos",
      "titleKey": "section.posWorkspace.openOrdersSection.title",
      "mode": "edit",
      "order": 10,
      "organisms": [
        {
          ...
          "purpose": "Exibe todos os pedidos abertos do turno em colunas por status (registered, confirmed, inPreparation, ready, served, cancelled), permitindo ao atendente e cozinheiro identificar gargalos e acompanhar o andamento em tempo real.",
          "userActions": [
            "queryOpenOrders"
          ],
          "requiredEntities": [],
    ...
    {
      "id": "section.posWorkspace.createOrderSection",
      "type": "section",
      "sectionName": "Lançar Pedido",
      "titleKey": "section.posWorkspace.createOrderSection.title",
      "mode": "edit",
      "order": 20,
      "organisms": [
        {
    ...
    {
      "id": "section.posWorkspace.paymentSection",
      "type": "section",
      "sectionName": "Registrar Pagamento",
      "titleKey": "section.posWorkspace.paymentSection.title",
      "mode": "edit",
      "order": 30,
      "organisms": [
        {
